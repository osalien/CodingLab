...
package com.osalien.www.framework.util;
...
public class PrintApplicationInfo {
    ...
    public static void printTip(ConfigurableApplicationContext context) {
        ...
        tip.append(" 3.启动SpringBootAdmin Server，可选操作，admin模块中，启动CodingLabAdminApplication\n");
        ...
        tip.append("    work：        业务自定义模块，自己的业务代码可在work下进行，也可以再创建模块\n");
        tip.append("    framework：   项目核心框架模块\n");
        tip.append("    generator：   代码生成模块，启动类：CodingLabGenerator，请根据实际情况进行配置\n");
...
//        tip.append(" 8.QQ：625301326，进群答案：springboot.plus\n");
    ...
    public static void print(ConfigurableApplicationContext context) {
        ...
        // 项目IP或域名地址
        String serverIp = environment.getProperty("coding-lab.server-ip");
        // 项目端口
        ...
        log.info("coding-lab project start success...........");
        if ("dev".equals(profileActive)) {
