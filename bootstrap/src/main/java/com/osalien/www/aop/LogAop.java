...
package com.osalien.www.aop;

import com.osalien.www.framework.log.aop.BaseLogAop;
...
@Aspect
@Component
@ConditionalOnProperty(value = {"coding-lab.aop.log.enable"}, matchIfMissing = true)
public class LogAop extends BaseLogAop {
    ...
    private static final String POINTCUT =
            "execution(public * com.osalien.www..*.controller..*.*(..)) || " +
                    "execution(public * com.osalien.www.work..*.controller..*.*(..))";
