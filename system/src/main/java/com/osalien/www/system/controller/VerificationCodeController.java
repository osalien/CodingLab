...
import com.osalien.www.framework.util.UUIDUtil;
import com.osalien.www.framework.util.VerificationCode;
...
@ConditionalOnProperty(value = {"coding-lab.enable-verify-code"}, matchIfMissing = true)
